  ...
  <section class="content-header">
    ...
    <div class="card card-primary">
               ...
               {{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('name',$getRecord->name) }}" name="name" placeholder="Enter new Category Name" required >
                  </div>
                  <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input 
              type="checkbox" 
              {{!empty($getRecord->is_home) ? 'checked' : ''}}
